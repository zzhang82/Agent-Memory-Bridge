...
- Proof discipline：release contract、public-surface check、onboarding check、benchmark snapshot，以及 `289 passed`。
...
`0.14.2` 是 service automation hardening patch，建立在 governed learning-candidate release 之上，同时保持 public tool surface 稳定。
