...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Write the minimal live source manifest for profile fallback files.")
    parser.add_argument(
        "source_root",
        nargs="?",
        type=Path,
    ...
    parser.add_argument(
        "--manifest-path",
        type=Path,
        help="Optional path for the live source manifest. Defaults to <profile-source>/live-source-manifest.json.",
    )
